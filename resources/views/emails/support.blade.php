                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="background-color: #ffffff; border-radius: 8px; padding: 20px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="text-align: center; padding-bottom: 20px;">
                            ...
                            <p style="color: #7f8c8d; font-size: 14px;">Data de envio: {{ date('d/m/Y H:i') }}</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding-bottom: 20px;">
                            <p style="color: #2c3e50; font-size: 16px;"><strong>Nome:</strong> {{ $nome }}</p>
                            <p style="color: #2c3e50; font-size: 16px;"><strong>Email:</strong> {{ $email }}</p>
                        </td>
                    </tr>
